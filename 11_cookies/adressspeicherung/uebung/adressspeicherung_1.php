    ...
    <form action="adressspeicherung_2.php" method="post">
      <div class="form-group">
        <div class="radio-inline">
          <input type="radio" class=""name="anrede" value="Frau">Frau</label>
        </div>
        <div class="radio-inline">
      ...
      <div class="form-group">
        <label for="vname" class="col-2 col-form-label">Vorname</label>
        <div class="col-10">
      ...
      <div class="form-group">
        <label for="nname" class="col-2 col-form-label">Nachname</label>
        <div class="col-10">
          <input class="form-control" type="text" name="nname" value="
          <?php
